...
const Body =({fname, domains, position1, position2, socials,selfi})=>{
    return(
        <>
        <div className="my-auto flex w-full px-6 md:px-10 py-8">
            <div className=" m-auto flex flex-col space-y-16 md:space-y-0 md:flex-row md:space-x-12 md:justify-center justifu-center  w-full ">
                ...
                '>
                    <h1 className='w-fit text-4xl md:text-5xl font-semibold font-sans mb-4'>Hi, I'm <span className='text-red font-bold'>{fname}</span><span className='animate-wave'>&nbsp;🤚</span></h1>
